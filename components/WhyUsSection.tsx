...
export default function WhyUsSection() {
  ...
  const headingOpacity = useTransform(scrollYProgress, [0, 0.8], [1, 0.4]);
    ...
    >
      ...
      <div className="sticky top-0 h-screen overflow-hidden container-app flex flex-col md:grid md:grid-cols-2 md:gap-16 md:items-center">
        ...
        <motion.div
          ...
          className="origin-left pt-12 pb-4 md:py-0 flex flex-col gap-3 md:gap-6"
        >
        ...
        <div className="relative flex-1 md:h-full flex items-center md:items-center">
          {points.map((point, i) => (
            <PointCard
              key={i}
              point={point}
