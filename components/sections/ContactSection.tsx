  ...
  return (
    ...
    >
      ...
      <div className="relative md:h-screen h-[700px] w-full mx-auto flex flex-col lg:gap-20 gap-70  items-center md:justify-center justify-between">
        <DecorativeStar className="absoluter lg:w-10 md:w-10 w-10 lg:top-[12%] lg:left-[26%] md:top-[18%] md:left-[15%] top-[15%] left-[5%]  opacity-60" />
        <DecorativeStar className="absoluter lg:w-4 md:w-4 w-4 lg:top-[11%] lg:left-[28%] md:top-[17%] md:left-[14%] top-[13%] left-[3%]  opacity-40" />
        <DecorativeStar className="absoluter lg:w-10 md:w-10 w-10 lg:top-[30%] lg:right-[25%] md:top-[32%] md:right-[15%] top-[32%] right-[7%]  opacity-60" />
        <DecorativeStar className="absoluter lg:w-4 md:w-4 w-4 lg:top-[29%] lg:right-[27%] md:top-[31%] md:right-[19%] top-[30%] right-[5%] opacity-40" />
