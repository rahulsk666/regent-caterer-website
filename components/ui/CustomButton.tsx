...
// Exported so callers that need button styling on a non-<button> element
// (e.g. a Link that must not nest inside/around another interactive
// element) can reuse the exact same classes instead of duplicating them.
